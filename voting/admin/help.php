...
<div id="settings_form" style="padding-left: 15px; padding-right: 15px;">
    ...
    <ul>
        ...
        <li><a href="#change_diplay_templates"><?php _e('How to change the way the votes are displayed?', 'voting'); ?></a></li>
        <li><a href="#"></a></li>
    </ul>
    ...
    <h2><span class="anchor" id="show_best_rated"></span><?php _e('How can I show best rated listings or users?', 'voting') ;?><a class="gotop"><?php _e('Start of page', 'voting'); ?></a></h2>
    ...
    <h2><span class="anchor" id="change_place_votes"></span><?php _e('Change place of "voting plugin"', 'voting') ; ?><a class="gotop"><?php _e('Start of page', 'voting'); ?></a></h2>
    ...
    <h2><span class="anchor" id="rating_on_user_dash"></span><?php _e('How can I show user rating on user dashboard?', 'voting') ;?></h2>
    ...
    <h2><span class="anchor" id="change_diplay_templates"></span><?php _e('How to change the way the votes are displayed in xx plugin?', 'voting'); ?><a class="gotop"><?php _e('Start of page', 'voting'); ?></a></h2>
